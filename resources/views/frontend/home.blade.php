...
@section('body')
    ...
    <div class="flex w-full justify-center mt-10">
        <form class="w-1/2" action="">
            <label for="large" class="block mb-2 text-base font-medium text-gray-900 dark:text-gray-400">Stadim</label>
            <select id="large"
            ...
            <div class="relative">
                ...
                <input datepicker datepicker-autohide id="date" type="text" name="date"
